...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		...
		gridDifference		: 25000,	//to make the grid blocks slower than the slices, this value must be smaller than transPeriod
...
////////callbacks
	...
	if(opts.thumbnails==true){
		...
		//wrap.append(
		//	'<div class="camera_msg_cont" />'
		//);
		//$('.camera_msg_cont').append(
		//	'<h6>uniqueness</h6>'
		//);
		//$('.camera_msg_cont').append(
		//	'<h1>honesty, interity & fairness</h1>'
		//);
		//$('.camera_msg_cont').append(
		//	'<p>Doreen is a persuit of change nd up gradation. It is persuing new business opportunities in the dynamic economic spectrum of Bangladesh and the world.</p>'
		//);
		//$('.camera_msg_cont').append(
		//	'<span>our all concerns</span>'
		//);
		//$('.camera_msg_cont').append(
		//	'<div></div>'
		//);
	...
	function nextSlide(navSlide){ 
		...
		$('.cameraContent',fakeHover).fadeOut(900);
		$('.camera_caption',fakeHover).show();
