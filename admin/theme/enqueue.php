...
function dg_scripts() {
    ...
    wp_register_style( 'animate', get_stylesheet_directory_uri().'/resource/css/animate.min.css');
    ...
    wp_register_script( 'smooth-scroller', get_stylesheet_directory_uri().'/resource/js/jquery.smooth-scroll.js', array( 'jquery' ), '', true );
	wp_enqueue_script( 'smooth-scroller' );
    ...
    wp_register_script( 'imagesloaded', get_stylesheet_directory_uri().'/resource/js/imagesloaded.pkgd.min.js', array( 'jquery'), '', true );
	wp_enqueue_script( 'imagesloaded' );
    
    wp_register_script( 'wow', get_stylesheet_directory_uri().'/resource/js/wow.min.js', array( 'jquery'), '', true );
